...
function mostrarlistas(rpta) {
    if (rpta) {
        ...
        if (vista == "Proveedor") {
            ...
            crearCombo(listaUniMed, "unidaMedidaInact", "Seleccione");
...
function configurarBotones() {
    ...
    if (btnNuevo != null) btnNuevo.onclick = function () {
        ...
        var dtgSbn = document.getElementById("dtgSbn");
        if (dtgSbn != null) {
            $('#dtgSbn').bootstrapToggle('off')
        }
        var dtgActivo = document.getElementById("dtgActivo");
        if (dtgActivo != null) {
    ...
    if (btnGuardar != null) btnGuardar.onclick = function () {
        ...
        if (vista == "PedidoCompra" && validarPedido()) {
            ...
            else if (cboTipoContribuyente.value == "1") {
                mostrarMensaje("Seleccione Tipo Contribuyente", "error");
    ...
    if (btnListado != null) btnListado.onclick = function () {
        ...
        if (vista == "Articulo") {
            ...
            data = idTipo + '||||2';
            cboTipoBienInact.value = idTipo;
            var select2cboUnidadMedida = document.getElementById("select2-unidaMedidaInact-container");
            if (select2cboUnidadMedida != null) select2cboUnidadMedida.innerHTML = "Seleccione";
...
function mostrarRegistro(rpta) {
    if (rpta) {
        ...
        if (vista == "PedidoCompra") {
            ...
            dtgSbn.value = campos[5];
            dtgActivo.value = campos[6];
            ...
            document.getElementById("chkEsProveedor").checked = true;
